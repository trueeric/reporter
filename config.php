...
$from_email = 'yhsh50@gm.yhsh.tn.edu.tw'; //Webmaster email
$from_name  = 'yhsh50'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server   = 'smtp.gmail.com'; //'smtp.mail.domain.com';
$smtp_user     = 'yhsh50@gm.yhsh.tn.edu.tw'; //'youremail@domain.com';
$smtp_pw       = 'yhsh2455293'; //'yourEmailPassword';
